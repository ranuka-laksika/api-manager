...
export declare type MenuBaseItem = {
    ...
    title: string;
    /**
     * Optional text-like (ReactText) value or element to render on the right side of the menu item. Use this to display keyboard shortcut, badge counts, etc.
     * When this item is disabled, the styling is dependent on the component provided:
     * If the value is text-like, this component controls the styling. Otherwise, the styling is up to the passed in component.
     */
    meta?: ReactNode;
    /**
