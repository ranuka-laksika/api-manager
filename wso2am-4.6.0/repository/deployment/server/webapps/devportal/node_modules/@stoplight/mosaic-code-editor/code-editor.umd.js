(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('react/jsx-runtime'), require('@stoplight/mosaic'), require('@stoplight/mosaic-code-viewer'), require('clsx'), require('react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'tslib', 'react/jsx-runtime', '@stoplight/mosaic', '@stoplight/mosaic-code-viewer', 'clsx', 'react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.CodeEditor = {}, global.tslib, global.jsxRuntime, global.mosaic, global.mosaicCodeViewer, global.cn, global.React));
})(this, (function (exports, tslib, jsxRuntime, mosaic, mosaicCodeViewer, cn, React) { 'use strict';
    ...
    render() {
      const _a = this.props,
        ...
        preClassName
            ...
            rest = tslib.__rest(_a, ["value", "style", "padding", "highlight", "textareaId", "className", "autoFocus", "disabled", "form", "maxLength", "minLength", "name", "placeholder", "readOnly", "required", "onClick", "onFocus", "onBlur", "onKeyUp", "onKeyDown", "onValueChange", "tabSize", "insertSpaces", "ignoreTabKey", "preClassName"]);
  ...
  const CodeEditor = _a => {
    ...
    var {
      ...
      borderColor = {
        ...
        props = tslib.__rest(_a, ["value", "language", "className", "style", "placeholder", "autoFocus", "showLineNumbers", "onChange", "padding", "intent", "border", "borderColor"]);
    ...
    return jsxRuntime.jsx(mosaic.Box, Object.assign({
      ...
      children: jsxRuntime.jsxs(mosaic.NoSsr, Object.assign({
