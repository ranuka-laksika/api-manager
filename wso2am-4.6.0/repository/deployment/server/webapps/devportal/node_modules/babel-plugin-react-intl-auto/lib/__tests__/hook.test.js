...
const filename = _path.default.resolve(__dirname, '..', '__fixtures__', 'messages.js');
...
const tests = [defaultTest, multiUseTest, withValueInMessageTest, withVariableMessageTest, withVariableMessageDescriptor, withCustomProperties, someSupportedUseCases, importAsTest, throwWhenNotAnalyzableTest, notTransformIfNotImportedTest, notTransformIfIdIsProvided, injectIntlWithProps, withKeyFlag];
(0, _testUtils.cases)(filename, [{
  title: 'default',
  tests
}, {
