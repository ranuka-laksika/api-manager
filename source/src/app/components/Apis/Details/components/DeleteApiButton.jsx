            ...
            promisedDelete
                .then((response) => {
                    ...
                    if (updateData) {
                        ...
                        // Fetch the latest API Product count before redirecting
                        const apiClient = new API();
                        apiClient.getAllAPIs({ limit: 1 }).then(() => {
            ...
            promisedDelete
                .then((response) => {
                    ...
                    if (updateData) {
                        ...
                        // Fetch the latest MCP Server count before redirecting
                        const mcpServerClient = new MCPServer();
                        mcpServerClient.getAllMCPServers({ limit: 1 }).then(() => {
            ...
            promisedDelete
                .then((response) => {
                    ...
                    if (updateData) {
                        ...
                        // Fetch the latest API count before redirecting
                        const apiClient = new API();
                        apiClient.getAllAPIs({ limit: 1 }).then(() => {
                            history.push('/apis');
                        }).catch(() => {
