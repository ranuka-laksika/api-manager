...
export declare type TextColorVals = 'current' | 'body' | 'muted' | 'disabled' | 'light' | 'heading' | 'paragraph' | 'canvas' | 'canvas-pure' | 'canvas-tint' | 'canvas-50' | 'canvas-100' | 'canvas-200' | 'canvas-300' | 'canvas-dialog' | SemanticColorVals;
...
export declare type BackgroundColorVals = 'canvas' | 'canvas-dark' | 'canvas-pure' | 'canvas-tint' | 'canvas-50' | 'canvas-100' | 'canvas-200' | 'canvas-300' | 'canvas-400' | 'canvas-500' | 'canvas-dialog' | 'transparent' | SemanticColorVals;
